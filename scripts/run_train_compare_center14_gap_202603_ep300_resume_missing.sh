...
Options:
  ...
  --no-skip-existing-models retrain even when the target model file exists
...
run_train_model() {
  ...
  if [[ "$SKIP_EXISTING_MODELS" -eq 1 && -f "$model_path" ]]; then
